...
<div class="vh-100 border">
  <p style="margin-top: 0; padding: 1.5%;">自分のプロフィール</p>
  <div class="top_area w-75 m-auto pt-5">
    <div class="user_status p-3" style="box-shadow:0 0 8px #808080;">
      ...
      <p>性別：@if(Auth::user()->sex == 1)<span>男</span>@elseif(Auth::user()->sex == 2)<span>女</span>@elseif(Auth::user()->sex == 3)<spn>その他</spn>@endif</p>
